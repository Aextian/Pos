...
return new class extends Migration
{
    ...
    {
        Schema::table('product_price_logs', function (Blueprint $table) {
            $table->dropForeign('product_price_logs_business_id_foreign');
            $table->dropForeign('product_price_logs_created_by_foreign');
            $table->dropForeign('product_price_logs_product_id_foreign');
        });
    }
};
