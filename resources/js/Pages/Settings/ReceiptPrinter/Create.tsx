      ...
      <MainLayout>
        ...
        <CardBorderTop>
          <LabelRow>
            ...
            <TextInput placeholder="Short Descriptive Name to recognize printer" className="text-xs p-2 w-full" />
          </LabelRow>
          <LabelRow>
          ...
          <LabelRow>
            ...
            <TextInput placeholder="IP address for connecting to the printer" className="text-xs p-2 w-full" />
          </LabelRow>
          <LabelRow>
