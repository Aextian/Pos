    ...
    <MainLayout>
      ...
      <CardBorderTop>
        <div className="space-y-5">
          ...
          <p className="dark:text-white">Follow the instructions carefully before importing the file. The columns of the CSV file should be in the following order.</p>
