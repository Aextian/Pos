...
const Create: React.FC<Type> = ({ type }) => {
      ...
      <CardBorderTop>
        ...
        <CardBorderTop.Content>
          <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <>
                  ...
                  <LabelRow>
                    ...
                    <div className="relative">
                      ...
                      <TextInput onChange={handleChange} className="ps-10 w-full text-xs" type="number" />
                    </div>
                  </LabelRow>
                </>
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 border-t pt-5">
              <LabelRow>
