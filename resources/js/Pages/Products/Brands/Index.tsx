        ...
        <MainLayout>
            ...
            <CardBorderTop>
                <div className="flex flex-row justify-between items-center gap-2">
                    <h1 className="text-lg">All your brands</h1>
                    <button type="button" onClick={() => setShowModal(!showModal)} className="rounded-lg px-5 py-1 bg-cyan-500 text-white font-medium">
                        Add
                    </button>
                </div>
