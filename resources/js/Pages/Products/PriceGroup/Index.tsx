    ...
    return (
        <MainLayout>
            <Modal show={showModal} maxWidth="2xl" closeable={true} onClose={() => router.visit(route('price-group.index'))}>
                ...
                <div className="text-xs p-5 space-y-4 w-full">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea className="w-full" name="" id="" cols={30} rows={3}></textarea>
                    </div>
                </div>
            ...
            <div className="px-5 md:px-2">
                <h1 className="text-lg">Selling Price Group</h1>
            </div>
            <CardBorderTop>
                <div className="flex flex-row justify-between items-center gap-2">
                    <h1 className="text-lg">All Selling Price Group</h1>
