      ...
      <div className={`${open === 'POS' ? '' : 'hidden'}  grid gap-5 `}>
        <div className="text-[10px] space-y-3 dark:text-white">
          ...
          <p>
            ...
            <span className="font-bold">ctrl+shift+b, ctrl+h</span>
          </p>
          <p className="font-bold">Available key names are:</p>
          <p>
            {' '}
            shift, ctrl, alt, backspace, tab, enter, return, capslock, esc, escape, space, pageup, pagedown,
            end, home, left, up, right, down, ins, del, and plus
          </p>
        </div>
        <table>
